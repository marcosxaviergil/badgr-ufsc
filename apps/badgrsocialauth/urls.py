...
from badgrsocialauth.api import external_auth_providers
...
urlpatterns = [
    ...
    # ✅ NOVO: Endpoint para providers configurados
    url(r'^external-providers$', external_auth_providers, name='external_auth_providers'),
