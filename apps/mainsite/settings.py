...
INSTALLED_APPS = [
    ...
    'badgrsocialauth',
    'badgrsocialauth.providers.ufsc',
...
# ========== SOCIAL AUTH UFSC - AUTO VERIFICAÇÃO ==========
SOCIALACCOUNT_AUTO_SIGNUP = True
SOCIALACCOUNT_EMAIL_VERIFICATION = 'none'
ACCOUNT_EMAIL_VERIFICATION = 'none'

# ✅ FORÇAR VERIFIED_EMAIL para provider UFSC
if 'ufsc' in SOCIALACCOUNT_PROVIDERS:
    SOCIALACCOUNT_PROVIDERS['ufsc']['VERIFIED_EMAIL'] = True

# ✅ CONFIGURAR ADAPTER PERSONALIZADO
SOCIALACCOUNT_ADAPTER = 'badgrsocialauth.adapter.BadgrSocialAccountAdapter'

# ========== CONFIGURAÇÕES PADRÃO BADGRAPP (usando variáveis de ambiente) ==========
DEFAULT_BADGR_CORS = os.environ.get('UI_URL', 'https://badges.setic.ufsc.br').replace('https://', '').replace('http://', '')
BADGR_APP_ID = None  # Será definido automaticamente pelo sistema
