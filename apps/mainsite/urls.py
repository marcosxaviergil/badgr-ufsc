...
from mainsite.views import UFSCRedirectView
...
urlpatterns = [
    # ✅ INTERCEPTAR TENTATIVAS DE LOGIN DO FRONTEND (ANTES DAS OUTRAS URLs)
    url(r'^accounts/ufsc/login/$', UFSCRedirectView.as_view(), name='ufsc_frontend_redirect'),
