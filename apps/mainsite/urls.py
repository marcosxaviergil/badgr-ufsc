...
urlpatterns = [
    ...
    # ✅ CORREÇÃO CRÍTICA: ORDEM ESPECÍFICA PARA EVITAR RECURSÃO
    # Social Auth primeiro (intercepta algumas URLs)
    url(r'^accounts/', include('badgrsocialauth.urls')),
    # Allauth depois (URLs padrão)
    ...
    # External tools - ✅ REMOVIDA DUPLICAÇÃO
