...
# ✅ ADICIONADO: View para redirecionar frontend /accounts/ufsc/login/ para backend OAuth
class UFSCRedirectView(RedirectView):
    permanent = False
    query_string = True
    pattern_name = 'socialaccount_login'

    def get_redirect_url(self, *args, **kwargs):
        # Redireciona para o endpoint de login social do allauth com o provider UFSC
        return super(UFSCRedirectView, self).get_redirect_url(provider='ufsc')
