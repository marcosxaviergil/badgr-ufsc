...
const ROUTE_CONFIG: Routes = [
	...
	// ✅ Rota para redirecionamento UFSC OAuth no frontend
	{
...
export const appInitializerFn = (configService: AppConfigService) => {
	return async () => {
		...
		// ✅ Configuração UFSC OAuth no localStorage
		localStorage.setItem('config', JSON.stringify({
			api: { baseUrl: "https://api-badges.setic.ufsc.br" },
			features: {
...
@NgModule({
	imports: [
		...
		UFSCOAuthModule,  // ✅ Adicionar módulo UFSC OAuth
	],
	declarations: [
		AppComponent,
