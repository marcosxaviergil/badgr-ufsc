...
// ✅ COMENTADO: Remover módulo UFSC OAuth que causa redirecionamento automático
// import { UFSCOAuthModule } from './ufsc-oauth/ufsc-oauth.module';
...
const ROUTE_CONFIG: Routes = [
	...
	// ✅ COMENTADO: Remover redirecionamento automático UFSC
	// {
	//	path: 'accounts/ufsc/login',
	//	redirectTo: '/ufsc-redirect',
	//	pathMatch: 'full'
	// },
...
export const appInitializerFn = (configService: AppConfigService) => {
	return async () => {
		...
		// ✅ REMOVIDO: Configuração estática no localStorage que causava duplicação
...
@NgModule({
	imports: [
		...
		// ✅ COMENTADO: Remover módulo UFSC OAuth que causa redirecionamento
		// UFSCOAuthModule,
	],
	declarations: [
		AppComponent,
